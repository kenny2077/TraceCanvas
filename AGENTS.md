...
TraceCanvas is a UMN project. The main application lives in `tracecanvas/`.
...
| README rewrite | ✅ Done | `tracecanvas/README.md` |
...
- `/Users/kenny/Desktop/UMN/Projects/TraceCanvas/` - Project root
  - `tracecanvas/` - Next.js application (see its own AGENTS.md)
...
### Navigation
- `cd tracecanvas` to enter the app directory

### Inside tracecanvas/
- Install: `pnpm install --frozen-lockfile`
- Guard shape: `pnpm exec tsx scripts/guard.ts`
- App dev: `pnpm -F @tracecanvas/next dev`
- App typecheck: `pnpm -F @tracecanvas/next typecheck`
- App unit tests: `pnpm -F @tracecanvas/next test`
- App build: `pnpm -F @tracecanvas/next build`
- E2E typecheck: `pnpm -F @tracecanvas/e2e typecheck`
- E2E tests: `pnpm -F @tracecanvas/e2e test`
...
2. Read tracecanvas/AGENTS.md for Next.js-specific rules
