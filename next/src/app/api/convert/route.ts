...
import { validateJsonRequest, badRequest, ConvertRequestSchema } from "@/lib/validation/schemas";
...
export async function POST(req: NextRequest) {
  const parsed = await validateJsonRequest<Body>(req, ConvertRequestSchema);
