...
export type VerifyProfile = "strict" | "strict-numbers" | "medium" | "relaxed";
...
export type SkillFrontmatter = {
  ...
  recommended?: number;
  tags?: string[];
  /** Verification strictness: strict, strict-numbers, medium, relaxed. */
  verify_profile?: VerifyProfile;
  /** Additional source-key annotation rules injected into the prompt. */
  source_key_rules?: string;
...
export type SkillMeta = {
  ...
  /** Verification strictness profile. */
  verifyProfile?: VerifyProfile;
  /** Additional source-key rules for the prompt. */
...
function fmToMeta(id: string, fm: SkillFrontmatter, hasHtml: boolean, hasMd: boolean): SkillMeta {
  ...
  if (fm.verify_profile) meta.verifyProfile = fm.verify_profile as VerifyProfile;
  if (fm.source_key_rules) meta.sourceKeyRules = fm.source_key_rules;
